                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="project_title" value="" id="project_title"
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="project_name" value="" id="project_name"
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"> Please add </span>
                                            @enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="project_link" value="" id="project_link"
                                                placeholder="Project URL" class="form-control">
                                            @error('project_link')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
