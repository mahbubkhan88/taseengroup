...
@section('title', 'Edit Mission Vission & Value')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Edit Mission Vission & Value</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Edit Mission Vission & Value</li>
        </ol>
    </section>
    <!-- Content Header (Page header) -->
            ...
            <div class="col-md-8">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Mission Vission & Value</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('mission_vision_value.update', $data->id) }}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <img id="showImage"
                                        src="{{ (!empty('uploads/mission_vision_value_images/'.$data->image)) ? url('uploads/mission_vision_value_images/'.$data->image) : url('uploads/no_image.jpg') }}"
