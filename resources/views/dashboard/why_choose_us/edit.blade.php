...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Why Choose Us</li>
        </ol>
    </section>
    <!-- Content Header (Page header) -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('why_choose_us.update') }}" enctype="multipart/form-data"
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ $whyChoose->name }}" id="name"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img src="{{ (!empty($whyChoose->image)) ? url('uploads/why_choose_us_images/'.$whyChoose->image) : url('uploads/no_image.jpg') }}"
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{ route('why_choose_us.view') }}" class="btn btn-danger btn-sm">BACK</a>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
