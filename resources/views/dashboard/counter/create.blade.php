...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Counter</li>
        </ol>
    </section>
    <!-- Content Header (Page header) -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('counter.store') }}" class="form-horizontal">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="icon" value="" id="icon" placeholder="Icon"
                                        class="form-control">
                                    @error('icon')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="counter" value="" id="counter" placeholder="Counter"
                                        class="form-control">
                                    @error('counter')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
